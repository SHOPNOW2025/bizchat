      ...
      if (type === 'signup') {
        ...
        await sql`
          INSERT INTO profiles (
            id, name, owner_name, phone, country_code, logo, social_links, products, currency, return_policy, delivery_policy
          ) VALUES (
            ${bizId}, ${initialProfile.name}, ${initialProfile.ownerName}, ${fullPhone}, ${country.code}, 
